...
class Item extends Component {
  ...
  render() {
      if(this.state.edit){
          ...
          return(
              <EditItem editedText={this.props.item.text} updateHandler={this.updateHandler}/>
          )
      }
      ...
      <>
        <li>
          ...
          <i onClick={this.deleteHandler} className="far fa-trash-alt"></i>
        ...
        </li>
        {
            ...
            :
              <button className="done__btn">
                  <i onClick={this.checkHandler} className="fas fa-check-circle"></i>
              </button>
